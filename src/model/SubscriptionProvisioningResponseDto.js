 ...
 * @version 1.0.0
 */
export class SubscriptionProvisioningResponseDto {
  /**
 ...
 * @member {String} ID
 */
SubscriptionProvisioningResponseDto.prototype.ID = undefined;

/**
 * The subscription invoice number, can be communicated publicly.
 * @member {String} subscriptionNumber
 */
SubscriptionProvisioningResponseDto.prototype.subscriptionNumber = undefined;

/**
 * The status of the subscription.
 * @member {String} status
 */
SubscriptionProvisioningResponseDto.prototype.status = undefined;

/**
 * The date the subscription has started.
 * @member {module:model/ModelInt} startDate
 */
SubscriptionProvisioningResponseDto.prototype.startDate = undefined;

/**
 * The date the subscription will expire.
 * @member {module:model/ModelInt} endDate
 */
SubscriptionProvisioningResponseDto.prototype.endDate = undefined;
 ...
 */
SubscriptionProvisioningResponseDto.prototype.pluginDownloadUrls = undefined;

/**
 * The URL for the site connected to this subscription.
 * @member {String} siteUrl
 */
SubscriptionProvisioningResponseDto.prototype.siteUrl = undefined;
